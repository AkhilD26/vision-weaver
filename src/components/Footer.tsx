  ...
  return (
    <footer className="border-t border-border py-8 px-4">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <span className="font-display font-bold gradient-text">ProDAC Media</span>
        <p className="text-muted-foreground text-sm">
          © {new Date().getFullYear()} ProDAC Media. All rights reserved.
        </p>
        <div className="flex gap-4">
          ...
          <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
            WhatsApp
          </a>
        </div>
      </div>
